...
public class S2CLoginGameProfilePacket1_19 extends S2CLoginGameProfilePacket1_16 {

    public List<String[]> properties;

    public S2CLoginGameProfilePacket1_19() {
    }

    public S2CLoginGameProfilePacket1_19(final UUID uuid, final String name, final List<String[]> properties) {
        super(uuid, name);
