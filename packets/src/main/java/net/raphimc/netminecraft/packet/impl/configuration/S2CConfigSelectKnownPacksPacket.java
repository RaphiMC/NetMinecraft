...
public class S2CConfigSelectKnownPacksPacket implements Packet {

    public List<KnownPack> knownPacks;

    public S2CConfigSelectKnownPacksPacket() {
    }

    public S2CConfigSelectKnownPacksPacket(final List<KnownPack> knownPacks) {
