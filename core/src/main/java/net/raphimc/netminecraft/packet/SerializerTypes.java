...
public class SerializerTypes {
    ...
    public static TextComponentSerializer getTextComponentSerializer(final int protocolVersion) {
        if (protocolVersion >= MCVersion.v26_2) {
            return TextComponentCodec.V26_2.asSerializer();
        } else if (protocolVersion >= MCVersion.v26_1) {
            ...
            return TextComponentSerializer.V1_21_2;
        } else if (protocolVersion >= MCVersion.v1_20_5) {
